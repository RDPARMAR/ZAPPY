...
<%@page import="java.util.ArrayList,Dao.MyDao" %>
			...
			<div class="nav-top">
				<nav class="navbar navbar-default">
				 ...
				 <div class="cart" >
					...
					<a href="ShowCart">	<span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"></span></a></span>
					</div>
					<div class="clearfix"></div>
				</div>
	...
	<div class="banner-top">
		<div class="container">
			<h3>Zappy Food Store</h3>
			<h4>
				<a href="index.html">Home</a><label>/</label>Zappy Food Store
			</h4>
			<div class="clearfix"></div>
		</div>
	</div>
...
<form action="AddCart" method="post">
								...
								<td><%=b.getCatagory()%></td>
								 ...
								 <input type="hidden" name="pid" value="<%=b.getPid()%>">
                                   <td> <input type='number' name='quantity'  value='1' class='qty' /></td>
                                   
                                     <td><input type="submit" value="AddCart" name="submit" ></td>
                               	</form>
								<%
									}
								%>
