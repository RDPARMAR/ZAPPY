...
%>
	...
	<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1>
					<a href="index.jsp"><b>F<br>O<br>O<br>D
					</b>Zappy<span>Makes you Happy</span></a>
				</h1>
			</div>
			<div class="head-t">
				<ul class="card">
							...
							<li class="dropdown ">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="care.html"><img src="images/me1.png"
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="hold.html"><img src="images/me2.png"
												class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>
	...
	<div class="banner-top">
		<div class="container">
			<h3>View Product</h3>
			<h4>
				<a href="index.html">Home</a><label>/</label>Add Product
			</h4>
			<div class="clearfix"></div>
		</div>
	</div>
					...
					<div class="clearfix">
						<table width="100%" border="2">
							...
							<tr>
								...
								<td><%=b.getCatagory()%></td>
								 <td><img src="imgupload/<%=b.getImage()%>" width="50" height="50"/></td>
								 <td><a href="Update?pid=<%=b.getPid()%>">Update</a></td>
                                <td><a href="Delete?pid=<%=b.getPid()%>">DELETE</a></td>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-bottom">
				<h2>
					<a href="index.html"><b>F<br>O<br>O<br>D
					</b>ZAPPY<span>Makes you Happy</span></a>
				</h2>
