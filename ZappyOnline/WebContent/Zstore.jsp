							...
							<div class="col-md-3 pro-1">
								<div class="col-m">								
									<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="imgupload/<%=b.getImage()%>" width="50" height="50"/>
										 
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html"><%=b.getPname()%></a><%=b.getWeight()%></h6>							
										</div>
										<div class="mid-2">
											<p ><label><%=b.getPrice()%></label><em class="item_price"><%=b.getPrice()%></em></p>
											  <div class="block">
                                    ...
                                    <input type='number' name='quantity'  value='1' class='qty' />
										...
										<input type="submit" value="AddCart"  class="btn btn-danger my-cart-btn my-cart-b " name="submit" >
                               	</form>
	...
	<div class="container">
		...
		<div class="col-md-3 footer-grid ">
			...
			<ul>
				...
				<li><a href="ZappyProductStore">Online Shopping</a></li>						 
