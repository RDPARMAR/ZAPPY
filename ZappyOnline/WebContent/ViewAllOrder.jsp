...
<center><table width="100%" border="2">
			...
			<tr><th>OrderId</th><th>Productid</th><th>Quantity</th><th>Amount</th><th>Status</th><th>User</th><th>Date</th><th>Dispatch</th><th>Not Available</th></tr>
...
%>
  <tr>
	...
	<%if(b.getUser().equals("0")){ %>
						<td>Pending</td>
						<%}else if(b.getUser().equals("1")){ %>
						<td>Dispatch</td>
						<%}else if(b.getUser().equals("2")){ %>
						 <td>Delivered</td>
						<%}else if (b.getUser().equals("3")){%>
						 <td>Not Available</td>
						<%} %>
	
	<td><%out.println(b.getDate()); %></td>
	<td><%out.println(b.getStatus()); %></td>
