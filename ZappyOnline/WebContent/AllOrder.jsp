...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html"><b>F<br>O<br>O<br>D</b>Zappy<span>Makes you Happy</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">

					<li><a href="index.jsp" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
					
					<li><a href="Logout" ><i class="fa fa-ship" aria-hidden="true"></i>Logout</a></li>
				</ul>	
			</div>
...
<center><table width="100%" border="2">
			...
			<tr><th>OrderId</th><th>Productid</th><th>Quantity</th><th>User</th><th>Status</th><th>Date</th><th>Amount</th><!-- <th>Dispatch</th><th>Not Available</th> --></tr>

<!-- OrderId	Productid	Quantity	Amount	OrderDate	Status	User
O-ID 05802	113	5	150	raviparmar949@gmail.com
 -->
<%
ArrayList<OrderBean> al =(ArrayList<OrderBean>)request.getAttribute("orders");
for(OrderBean b : al){
%>
  <tr>
	...
	<td><%out.println(b.getUser()); %></td>
	<%-- <td><a href ="Dispatch?pid=<%out.println(b.getPid());%>&user=<%=b.getUser()%>&oid=<%=b.getOid()%>">Dispatch</a></td>
<td><a href ="MakeNotAvailable?pid=<%out.println(b.getPid());%>&user=<%=b.getUser()%>&oid=<%=b.getOid()%>">Not Available</a></td> --%>
</tr>
<%
}
%>
