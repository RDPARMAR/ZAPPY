...
<script src="https://apis.google.com/js/platform.js" async defer></script>
	<meta name="google-signin-client_id" content="447393152827-hgddklamhn147iq4er3v9v3btk7j5m7a.apps.googleusercontent.com">
		...
		<div class="container">
			...
			<div class="header-ri">
				<ul class="social-top">
					...
					<li><a href="https://twitter.com/login?lang=en" class="icon twitter"><i class="fa fa-twitter" aria-hidden="true"></i><span></span></a></li>
				...
				<div class="nav-top">
					...
					<a href="ShowCart">	<span class="fa fa-shopping-cart my-cart-icon"></a></span>
					</div>
    ...
    <div class="container">
		<div class="banner-info">
			...
			<div class="search-form">
				<form action="https://www.google.co.in/?gfe_rd=cr&dcr=0&ei=9ffWWqbKJbTT8geLjIHABQ">
